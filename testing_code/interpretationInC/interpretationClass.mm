...
*/
    ...
    -(NSMutableDictionary*)classificationEngine:(NSMutableDictionary*)tempDict{
        ...
        for ( id keys in tempDictKeys) {
            ...
            discValue = [NSNumber numberWithDouble: -0.7 * [tempDict[keys][9] doubleValue] - 0.9* [tempDict[keys][10] doubleValue] + 1.2* [tempDict[keys][11] doubleValue] - 0.6];
